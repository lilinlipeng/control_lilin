...
public class HealthNotice extends BaseEntity {
     ...
     */  
    @JsonProperty("Num")
    @TableField(value="Num",updateStrategy = FieldStrategy.IGNORED)
    private Integer Num;          
    ...
    @TableField(value="RemindTime",updateStrategy = FieldStrategy.IGNORED)
    ...
    @TableField(value="RemindType",updateStrategy = FieldStrategy.IGNORED)
    ...
    @TableField(value="IsRemind",updateStrategy = FieldStrategy.IGNORED)
