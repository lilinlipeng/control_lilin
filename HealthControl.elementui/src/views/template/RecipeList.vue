            ...
            <div class="margin-top-sm">
                <el-form :inline="true" :model="searchForm" size="default">
                    ...
                    <el-form-item label="审核状态">
                        <SigleSelect url="/Select/AuditStatusEnum" class="search-input" columnName="Name" :clearable="true" columnValue="Code"
              ...
              <el-row :gutter="10" class="edit-from-body">
                    ...
                    <el-col :span="24">
                        <el-form-item label="审核状态" prop="AuditStatus">
                          <SigleSelect url="/Select/AuditStatusEnum" columnName="Name" columnValue="Code"  v-model="formData.AuditStatus" >
                          </SigleSelect>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="24">
                        <el-form-item label="浏览量" prop="ViewCount">
                            <el-input-number  v-model="formData.ViewCount"  placeholder="请输入浏览量"     :clearable="true"  :min="1" :max="1000000"></el-input-number>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="24">
                        <el-form-item label="审核时间" prop="AuditTime">
                            <el-date-picker v-model="formData.AuditTime" align="right" type="datetime" placeholder="选择时间" value-format="YYYY-MM-DD HH:mm:ss">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
