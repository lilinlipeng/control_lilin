            ...
            <view class="form-container">
                ...
                <uni-forms ref="editModalForm" :model="formData" :rules="editModalFormRules" label-width='100'
                    ...
                    <uni-forms-item label="运动" required name="SportId">
                        <sigle-select url="/Sport/List" columnName="Name" columnValue="Id" v-model="formData.SportId">
                        </sigle-select>
                    </uni-forms-item>
                    <uni-forms-item label="运动单位" required name="SportUnitId">
                        <sigle-select url="/SportUnit/List" columnName="UnitName" columnValue="Id" v-model="formData.SportUnitId">
                        </sigle-select>
                    </uni-forms-item>
