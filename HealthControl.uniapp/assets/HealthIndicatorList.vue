        ...
        <view class="page-content">
            ...
            <view class="entry-section">
                ...
                <view class="left-cards">
                    ...
                    <view class="entry-card primary" @click="goToOfficialIndicators">
                        ...
                        <view class="entry-icon">
                            <uni-icons type="checkmarkempty" size="22" :color="themeColor"></uni-icons>
                        </view>
                        <!-- 卡片内容 -->
                    ...
                    <view class="entry-card secondary" @click="goToCustomIndicators">
                        <!-- 卡片图标 -->
                        <view class="entry-icon">
                            <uni-icons type="plusempty" size="22" :color="themeColor"></uni-icons>
                        </view>
                        <!-- 卡片内容 -->
                        <view class="entry-content">
                ...
                <view class="entry-card tertiary large-card" @click="goToMyRecords">
                    <!-- 卡片图标 -->
                    <view class="entry-icon">
                        <uni-icons type="list" size="28" :color="themeColor"></uni-icons>
                    </view>
                    <!-- 卡片内容 -->
                    <view class="entry-content">
...
.entry-card {
    ...
    &.primary {
        ...
        box-shadow: 
            0 4rpx 20rpx rgba(16, 185, 129, 0.15),
            inset 0 1rpx 0 rgba(255, 255, 255, 0.6);

        &:active {
            box-shadow: 
                0 2rpx 10rpx rgba(16, 185, 129, 0.2),
                inset 0 1rpx 0 rgba(255, 255, 255, 0.4),
                0 0 0 3rpx rgba(16, 185, 129, 0.1);
        }
    }
